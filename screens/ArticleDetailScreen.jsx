...
const ArticleDetailScreen = ({ route }) => {
  ...
  const renderTabButton = (section, label, icon) => (
    <TouchableOpacity
      key={section}
      style={[
        styles.tabButton,
    ...
    >
      <LinearGradient
        colors={activeSection === section ? ['#E68A50', '#D4743A'] : ['transparent', 'transparent']}
      ...
      >
        <FontAwesome5
          name={icon}
          size={16}
          color={activeSection === section ? '#fff' : '#E68A50'}
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={styles.headerTitleContainer}>
          ...
          <View style={styles.headerTextContainer}>
            ...
            <Text style={styles.headerSubtitle}>Complete Guide & Treatment</Text>
          </View>
        </View>
      </LinearGradient>
        ...
        <View style={styles.criticalAlert}>
          ...
          >
            <View style={styles.alertIconContainer}>
              <FontAwesome5 name="exclamation-triangle" size={20} color="#DC3545" />
            </View>
            <View style={styles.alertTextContainer}>
              <Text style={styles.alertTitle}>⚠️ Critical Recommendation</Text>
              <Text style={styles.alertText}>
                Due to extremely high mortality rate (99%), immediate culling is recommended to protect your flock.
              </Text>
            </View>
          </LinearGradient>
        </View>
      ...
      <View style={styles.tabContainer}>
        ...
        >
          {renderTabButton('description', 'Overview', 'info-circle')}
          {renderTabButton('precautions', 'Prevention', 'shield-alt')}
          {renderTabButton('remedies', 'Treatment', 'pills')}
        </ScrollView>
      </View>
...
const styles = StyleSheet.create({
  ...
  tabContainer: {
    ...
    shadowRadius: 4,
    borderBottomWidth: 1,
    borderBottomColor: 'rgba(230, 138, 80, 0.1)',
  },
  tabScrollContent: {
